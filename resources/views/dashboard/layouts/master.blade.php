...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180"
        href="{{ asset('Admin/src/assets/images/favicon_io/apple-touch-icon.png') }}">
    <link rel="icon" type="image/png" sizes="32x32"
        href="{{ asset('Admin/src/assets/images/favicon_io/favicon-32x32.png') }}">
    <link rel="icon" type="image/png" sizes="16x16"
        href="{{ asset('Admin/src/assets/images/favicon_io/favicon-16x16.png') }}">
                        ...
                        <ul class="list-unstyled p-0 m-0">
                            <li class="p-3 border-bottom ">
                                <div class="d-flex gap-3">
                                    <img src="{{ asset('Admin/src/assets/images/avatar/avatar-1.jpg') }}" alt=""
                            ...
                            <li class="p-3 border-bottom ">
                                <div class="d-flex gap-3">
                                    <img src="{{ asset('Admin/src/assets/images/avatar/avatar-4.jpg') }}" alt=""
                                        class="avatar avatar-sm rounded-circle" />
                                    <div class="flex-grow-1 small">
                            ...
                            <li class="p-3 border-bottom">
                                <div class="d-flex gap-3">
                                    <img src="{{ asset('Admin/src/assets/images/avatar/avatar-2.jpg') }}" alt=""
                                        class="avatar avatar-sm rounded-circle" />
                                    <div class="flex-grow-1 small">
    ...
    <aside id="sidebar" class="sidebar">
        <div class="logo-area">
            <a href="index.html" class="d-inline-flex"><img
                    src="{{ asset('Admin/src/assets/images/logo-icon.svg') }}" alt="" width="24">
                    ...
                    <div class="card  h-100">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item d-flex align-items-center gap-3">
                                <img src="{{ asset('Admin/src/assets/images/product-2.png') }}" class="rounded"
                                    width="48">
                            ...
                            <!-- repeat -->
                            <li class="list-group-item d-flex align-items-center gap-3">
                                <img src="{{ asset('Admin/src/assets/images/product-1.png') }}" class="rounded"
                                    width="48">
                                <div class="flex-grow-1">
                            ...
                            <li class="list-group-item d-flex align-items-center gap-3">
                                <img src="{{ asset('Admin/src/assets/images/product-3.png') }}" class="rounded"
                                    width="48">
                                <div class="flex-grow-1">
                            ...
                            <li class="list-group-item d-flex align-items-center gap-3">
                                <img src="{{ asset('Admin/src/assets/images/product-4.png') }}" class="rounded"
                                    width="48">
                                <div class="flex-grow-1">
                            ...
                            <li class="list-group-item d-flex align-items-center gap-3">
                                <img src="{{ asset('Admin/src/assets/images/product-5.png') }}" class="rounded"
                                    width="48">
                                <div class="flex-grow-1">
                ...
                <div class="col-lg-4">
                    <div class="card  h-100">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item d-flex align-items-center gap-3">
                                <img src="{{ asset('Admin/src/assets/images/product-8.png') }}" class="rounded"
                                    width="48">
                                <div class="flex-grow-1">
                            ...
                            <li class="list-group-item d-flex align-items-center gap-3">
                                <img src="{{ asset('Admin/src/assets/images/product-10.png') }}" class="rounded"
                                    width="48">
                                <div class="flex-grow-1">
                            ...
                            <li class="list-group-item d-flex align-items-center gap-3">
                                <img src="{{ asset('Admin/src/assets/images/product-6.png') }}" class="rounded"
                                    width="48">
                                <div class="flex-grow-1">
                ...
                <div class="col-lg-4">
                    <div class="card  h-100">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item d-flex align-items-center gap-3">
                                <img src="{{ asset('Admin/src/assets/images/product-7.png') }}" class="rounded"
                                    width="48">
                                <div class="flex-grow-1">
                            ...
                            <li class="list-group-item d-flex align-items-center gap-3">
                                <img src="{{ asset('Admin/src/assets/images/product-9.png') }}" class="rounded"
                                    width="48">
                                <div class="flex-grow-1">
