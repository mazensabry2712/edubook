                    ...
                    <tbody>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    <img class="avatar-img avatar-sm"
                                        src="{{ asset('Admin/assets/images/avatar/avatar-1.jpg') }}"
                                        alt="Sarah Ahmed">
                                    <div>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    <img class="avatar-img avatar-sm"
                                        src="{{ asset('Admin/assets/images/avatar/avatar-2.jpg') }}" alt="Rafi Khan">
                                    <div>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    <img class="avatar-img avatar-sm"
                                        src="{{ asset('Admin/assets/images/avatar/avatar-3.jpg') }}"
                                        alt="Nadia Islam">
                                    <div>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    <img class="avatar-img avatar-sm"
                                        src="{{ asset('Admin/assets/images/avatar/avatar-4.jpg') }}"
                                        alt="Mina Torres">
                                    <div>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    <img class="avatar-img avatar-sm"
                                        src="{{ asset('Admin/assets/images/avatar/avatar-5.jpg') }}" alt="Jon Oliver">
                                    <div>
